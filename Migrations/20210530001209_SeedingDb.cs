    ...
    public partial class SeedingDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Awesome and Delicious Hardy Candy", "Hardy Candy" },
                    { 2, "Scuptious and Chocolate Candy", "Chocolate Candy" },
                    { 3, "Sweet and Sour Fruit Candy", "Fruit Candy" },
                    { 4, "Sweet and Sour Fruit Candy", "Halloween Candy" },
                    { 5, "Sweet and Sour Fruit Candy", "Gummy Candy" }
                });
